...
#ketik(f"{white}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
ketik(f"\33[36;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
ketik(f"""   {white} - Pembuat {green}SKS STORE          {white}  - TikTok {green} PT.SKS HOLIDAY""")
ketik(f"""   {white} - Script {green}BUS SIMULATOR ID        {white}  - Version {green} 5.0 """)
ketik(f"\33[36;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
ketik(f"""   {white} -  {green} JANGAN LUPA FOLLOW, LIKE, KOMEN, DAN SHARE""")
ketik(f"""   {white} -  {green} อย่าลืมติดตาม ไลค์ แสดงความคิดเห็น และแบ่งปัน """)
ketik(f"\33[36;1m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
def mxx():
